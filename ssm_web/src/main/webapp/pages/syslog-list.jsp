			...
			<div class="box box-primary">
								...
								<c:forEach items="${pageInfo.list}" var="syslog">
									<tr>
										...
										<td class="text-center">
											<a href="${pageContext.request.contextPath}/sysLog/deleteById.do?id=${syslog.id}" class="btn bg-olive btn-xs">删除日志</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
				...
				<div class="box-footer">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							<li>
								<a href="${pageContext.request.contextPath}/sysLog?page=1&size=${pageInfo.pageSize}" aria-label="Previous">首页</a>
							</li>
							<%--${pageInfo.pageNum-1}--%>
